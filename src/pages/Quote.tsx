...
export default function Quote({version}: QuoteProps) {
        ...
        return (
            <div className="quote v2">
                ...
                <div className="contact">
                    ...
                    <hr />
                    <div className="gap"/>
                    <p className="fill-out-form"><span className="bold">Fill out the form and we'll get back to you within a few business days</span></p>
                </div>
                { isLoading ?
                <div className="loading">
                    <OrbitProgress 
